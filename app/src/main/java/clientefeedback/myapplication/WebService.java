...
public class WebService {
    ...
    public String doPost(String methodName, String params) {
        ...
        String base64EncodedCredentials = "Basic " + Base64.encodeToString(
                (autenticacaoString).getBytes(),
                Base64.NO_WRAP);

        String getUrl = webServiceUrl + methodName;
        httpPost = new HttpPost(getUrl);
        httpPost.addHeader("Authorization", base64EncodedCredentials);
        if("cadastro".equals(params)){
            String register = "Basic " + Base64.encodeToString((autenticacaoString).getBytes(),Base64.NO_WRAP);
            httpPost.addHeader("Register", register);
